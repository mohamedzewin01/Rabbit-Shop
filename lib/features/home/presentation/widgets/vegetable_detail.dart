...
import '../../../../views/common_widgets/item_key_points_view.dart';
import '../../../../views/common_widgets/search_text_field.dart';
...
class _VegetableDetailScreenState extends State<VegetableDetailScreen> {
  ...
  void initState() {
    ...
    multiImageProvider = [
      CachedNetworkImageProvider(widget.product.imagefronturl ?? ''),
      CachedNetworkImageProvider(widget.product.imagenutritionurl ?? ''),
    ];
  }
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(
                          "${widget.product.price ?? 10.00} / ${widget.product.quantity}",
                          style: TextStyle(
                        ...
                        Text(
                          "tags: ${widget.product.categories}",
                          style: TextStyle(
                        ...
                        Row(
                          children: [
                            ...
                            ItemKeyPointsView(
                                ...
                                title: "80 kcal",
                                desc: widget.product.quantity ?? "200 Gram")
                          ],
                        ),
                        SizedBox(
                          height: 20,
                    ...
                    children: [
                      Column(
                        children: [
                          ...
                          Text("${widget.product.price ?? 10.00}",
                              style: TextStyle(
                                  fontSize: 16,
                                  color: Colors.red,
                                  fontWeight: FontWeight.bold))
                      ...
                      Expanded(
                        ...
                        child: Obx(
                          () {
                            final cartItem = cartViewModel.productCartMap[
    ...
    return ElevatedButton(
      onPressed: () => {
        cartViewModel.addToCart(CartItem(
          ...
          quantity: widget.product.quantity,
          itemQuantity: 1,
          imagefrontsmallurl: widget.product.imagefrontsmallurl,
          imagefronturl: widget.product.imagefronturl,
